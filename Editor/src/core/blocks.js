...
const BLOCK_DEFINITIONS = [
	...
	// ==========================================
	{
		...
		color: '#00E676',
		// инпут комментария
		inputs: [{ label: 'Комментарий', default: '', type: 'text' }],
	},
	{
		id: 'evt_update',
		category: 'События',
	...
	},
	{
		...
		category: 'Логика',
		subcategory: 'Поток',
		label: 'Иначе если (Else If)',
		desc: 'Доп. условие, если предыдущее ложно.',
		icon: 'ri-question-mark',
		color: '#FF6D00',
		inputs: [
			{ label: 'Значение А', default: '1' },
	...
	},
	{
		...
		label: 'Логика (AND/OR)',
		desc: 'И / ИЛИ для условий.',
		icon: 'ri-links-fill',
		color: '#FF6D00',
		inputs: [
			{ label: 'Результат в', default: 'res' },
			{ label: 'Знач А', default: '1' },
			{
				label: 'Опер',
				type: 'select',
				default: 'AND',
